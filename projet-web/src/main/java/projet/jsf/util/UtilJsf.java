...
public class UtilJsf {
	...
	public static void messageError( Exception exception) {
		addMessage( FacesMessage.SEVERITY_ERROR, null, exception );
	}

	public static void addMessage( Severity severity, String message, Exception exception) {
	...
	public static <T> T getSessionAttribute(String key) {
		ExternalContext ec = FacesContext.getCurrentInstance().getExternalContext();
	  	return (T) ec.getSessionMap().get( key );
	}
	
	@SuppressWarnings("unchecked")
	public static <T> T removeSessionAttribute(String key) {
		ExternalContext ec = FacesContext.getCurrentInstance().getExternalContext();
	  	return (T) ec.getSessionMap().remove( key );
	}
	...
	public static String getRequestParameter( String key ) {
		ExternalContext ec = FacesContext.getCurrentInstance().getExternalContext();
		return ec.getRequestParameterMap().get( key ); 
	}
	
	@SuppressWarnings("unchecked")
	public static <T> T getRequestAttribute(String key) {
		ExternalContext ec = FacesContext.getCurrentInstance().getExternalContext();
	  	return (T) ec.getRequestMap().get( key );
	}
